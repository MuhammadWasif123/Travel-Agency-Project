    ...
    <>
      <div className="relative my-8 md:mt-3">
        <div className="w-[85vw] xl:w-[95vw] m-auto ">
          ...
          <div className="grid items-center grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-6 sm:ml-[44px] md:ml-[40px]">
            {placesAPI?.map((val,i)=>(
              ...
              <div className="text-slate-900 flex-col items-start">
                ...
                <p className="leading-[0px] font-openSans font-normal text-base lg:text-sm sm:text-xs xsm:leading-[0px] sm:leading-[0px] md:leading-[0px] lg:leading-[0px] xl:leading-[0px]">{val.distance}</p>
              </div>
